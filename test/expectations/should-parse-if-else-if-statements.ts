...
export class Main extends AppView<void> {
    ...
    constructor(context: void) {
        ...
        this.template = function($$view:AppView<void>, $$ctx:void) {
            return $$widget(Tag, {html : {  },wml : {  }}, $$if(value, function then(){ return $$node('text', {html : {  },wml : {  }}, 'Text') }, function elseif(){ return $$if(value, function then() { return $$node('text', {html : {  },wml : {  }}, 'else'); }, function else_clause() { return ' 
            no 
          ' } );}) )
        }
