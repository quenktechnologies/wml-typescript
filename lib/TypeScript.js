...
exports.importStatement2TS = function (n) {
    return "import " + exports.importMember2TS(n.member) + " from " + exports.string2TS(n.module);
};
/**
...
exports.exportStatement2TS = function (n) {
    return "export " + exports.compositeMember2TS(n.members) + ";";
};
/**
...
exports.funStatement2TS = function (n) {
    return "export function " + exports.unqualifiedIdentifier2TS(n.id) + exports.typeClasses2TS(n.typeClasses) +
        ("(" + n.parameters.map(exports.parameter2TS).join(',') + ")") +
...
exports.child2TS = function (n) {
    if ((n instanceof nodes.Node) || (n instanceof nodes.Widget))
        ...
        return exports.interpolation2TS(n);
...
exports.tag2TS = function (n) {
    var children = exports.children2TS(n.children);
...
exports.forStatement2TS = function (n) {
    return "$$for(" + exports.expression2TS(n.list) + ", function _for" +
...
exports.ifStatement2TS = function (n) {
    return "$$if(" + exports.expression2TS(n.condition) + ", " +
        "function then()" +
        ("{ return " + exports.children2TS(n.then) + " }, " + (n.elseClause ? else2TS(n.elseClause) : '$$empty') + ") ");
};
 ...
 */
exports.characters2TS = function (n) { return "'" + n.value + "'"; };
/**
...
exports.readExpression2TS = function (n) {
    return "$$resolve< " + exports.type2TS(n.hint) + ">(" + exports.expression2TS(n.path) + ", " + exports.expression2TS(n.target) + " " +
...
exports.contextProperty2TS = function (n) {
    return "$$ctx." + exports.identifier2TS(n.member);
};
/**
 * contextVariable2TS turns the context variable into the context identifier.
 */
exports.contextVariable2TS = function (_) { return "$$ctx"; };
/**
