...
var THROW_INVALIDATE_ERR = "       throw new Error('Cannot invalidate a view " +
...
var DOMGenerator = /** @class */ (function () {
    ...
    DOMGenerator.prototype.definitions = function (ctx) {
        return [
            ...
            "",
            "export type WidgetFunc<A extends " + output_1.WML + ".Attrs, W extends ",
            "     " + output_1.WML + ".WidgetConstructor<A>> = ",
            "(" + WIDGET_PARAMS + ") => " + output_1.WML + ".Content;",
            "",
            "export type ForAlt = ()=> " + output_1.WML + ".Content[]",
            "",
            ...
            "export const " + FOR_OF + " = <A>(o:Record<A>, f:ForOfBody<A>," +
                ("alt:ForAlt) : " + output_1.WML + ".Content[] => {"),
            "",
            "    let ret:" + output_1.WML + ".Content[] = [];",
            "",
            "    for(let key in o)",
    ...
    DOMGenerator.prototype.fun = function (ctx, n) {
        ...
        var factory = "(node: NodeFunc<any>, widget:WidgetFunc<any>) => ";
