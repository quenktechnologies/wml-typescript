...
exports.ifStatement2TS = function (ctx, n) {
    ...
    var alt = n.elseClause ? else2TS(ctx, n.elseClause) : 'function(){}';
    return "(" + condition + ") ? " + ctx.options.EOL + "\n           " + conseq + " : " + ctx.options.EOL + "\n           " + alt;
};
var else2TS = function (ctx, n) {
    if (n instanceof nodes.ElseClause)
        return exports.children2TS(ctx, n.children);
...
exports.funApplication2TS = function (ctx, n) {
    return "" + exports.expression2TS(ctx, n.target) + exports.typeArgs2TS(n.typeArgs) + " " +
        (_curriedApplication(ctx, n.args) + "(" + exports.THIS + ")");
};
var _curriedApplication = function (ctx, ns) {
...
exports.constructExpression2TS = function (ctx, n) {
    return "new " + exports.constructor2TS(n.cons) + " (" + exports.args2TS(ctx, n.args) + ")";
};
/**
 * callExpression2TS
 */
