...
var TypedMain = /** @class */ (function () {
    function TypedMain(typeClasses, context, parameters, tag, location) {
...
var FunStatement = /** @class */ (function () {
    function FunStatement(id, typeClasses, parameters, body, location) {
        this.id = id;
        this.typeClasses = typeClasses;
        this.parameters = parameters;
        this.body = body;
...
var Type = /** @class */ (function () {
    function Type(id, typeClasses, location) {
        this.id = id;
        this.typeClasses = typeClasses;
        this.location = location;
        this.type = 'type';
...
var ViewConstruction = /** @class */ (function () {
    function ViewConstruction(cons, args, location) {
        this.cons = cons;
        this.args = args;
        this.location = location;
