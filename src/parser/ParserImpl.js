...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[7,32,53],$V1=[1,5],$V2=[7,53],$V3=[1,13],$V4=[7,10,32,53],$V5=[1,20],$V6=[1,25],$V7=[12,24,26],$V8=[1,40],$V9=[1,41],$Va=[1,44],$Vb=[1,48],$Vc=[24,26],$Vd=[19,56,59],$Ve=[19,56,59,69,72,100],$Vf=[19,20,24,26,35,37,47,49,53,56,59,60,63,69,72,96,100,101,105,112,118,119,131,133,134,135,136,137,138,139,140,141,142],$Vg=[26,49],$Vh=[1,96],$Vi=[1,95],$Vj=[1,90],$Vk=[7,32,53,58,67,103],$Vl=[19,56,59,63],$Vm=[32,53,58,67,103],$Vn=[1,129],$Vo=[1,130],$Vp=[1,111],$Vq=[1,112],$Vr=[1,126],$Vs=[1,127],$Vt=[1,128],$Vu=[1,132],$Vv=[1,133],$Vw=[1,134],$Vx=[1,135],$Vy=[1,136],$Vz=[1,137],$VA=[1,138],$VB=[1,160],$VC=[1,158],$VD=[20,24,26,37,49,53,56,60,63,69,72,96,101,105,133,134,135,136,137,138,139,140,141,142],$VE=[1,163],$VF=[1,168],$VG=[1,167],$VH=[1,166],$VI=[1,169],$VJ=[1,170],$VK=[1,171],$VL=[1,172],$VM=[1,173],$VN=[1,177],$VO=[1,176],$VP=[1,185],$VQ=[1,186],$VR=[19,20,24,26,37,49,53,56,59,60,63,69,72,96,101,105,133,134,135,136,137,138,139,140,141,142],$VS=[1,204],$VT=[26,101,118],$VU=[26,35,101,118],$VV=[19,32,53,56,58,59,67,103],$VW=[69,72],$VX=[1,216],$VY=[20,24,26,37,49,53,56,60,63,69,72,96,101,105,119,133,134,135,136,137,138,139,140,141,142],$VZ=[2,86],$V_=[2,84],$V$=[20,24,26,37,49,53,56,60,63,69,72,96,101,133,134,135,136,137,138,139,140,141,142],$V01=[1,252],$V11=[26,49,101],$V21=[1,271],$V31=[19,22,47,100,107,114,116,118,126,128,131,143,144],$V41=[20,24,26,37,47,49,53,56,60,63,69,72,96,100,101,105,112,119,133,134,135,136,137,138,139,140,141,142],$V51=[2,88],$V61=[1,306],$V71=[1,317];
...
case 42:return 96;
break;
case 43:this.popState();            return 69;
break;
case 44:this.begin('EXPRESSION');   return 67;
break;
case 45:this.begin('CONTROL');      return 32;
break;
case 46:this.begin('COMMENT');      return;
break;
case 47:this.popState();            return 58;
break;
case 48:this.popState();            return 53;
break;
