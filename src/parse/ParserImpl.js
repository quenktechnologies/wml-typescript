...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,6],$V1=[1,5],$V2=[8,13],$V3=[1,14],$V4=[16,19,83],$V5=[1,18],$V6=[1,28],$V7=[1,37],$V8=[1,42],$V9=[1,38],$Va=[6,13,18,28,69,82],$Vb=[16,19,23,83],$Vc=[13,16,19,25,30,31,34,36,37,42,56,58,74,83,84,85,86,87,88,89,90],$Vd=[13,18,28,69,82],$Ve=[1,60],$Vf=[1,59],$Vg=[1,66],$Vh=[1,68],$Vi=[1,69],$Vj=[1,70],$Vk=[1,71],$Vl=[1,72],$Vm=[1,82],$Vn=[13,16,25,30,31,36,37,42,56,74,84,85,86,87,88,89,90],$Vo=[2,34],$Vp=[1,83],$Vq=[1,84],$Vr=[1,92],$Vs=[1,89],$Vt=[1,96],$Vu=[13,16,18,19,28,69,82,83],$Vv=[37,58],$Vw=[1,122],$Vx=[1,123],$Vy=[1,127],$Vz=[36,37,56,74],$VA=[73,83],$VB=[30,83],$VC=[34,55,59,60,61,83],$VD=[13,16,25,30,31,36,37,56,74,84,85,86,87,88,89,90];
